...
export const NEWS: NewsEntry[] = [
  {
    ...
    summary:
      'Cloud Imperium Games has moved Squadron 42 off its 2026 target. In a Letter from the Chairman published August 27, 2026, Chris Roberts wrote: "We have taken a look at the release windows at the start of 2027, and decided that Q2 provides a better time for Squadron 42 to release." The reason is Grand Theft Auto 6: Roberts said there is "no way" he wants his "spiritual successor to Wing Commander, a game that has had twelve years of blood, sweat and tears invested into it" launching "into the attention buzz saw of GTA6," adding that "While GTA6 isn’t launching on PC this November, pretty much all outlets and most content creators will be all over it, not leaving a lot of room for other coverage." Roberts confirmed the original plan had been to ship in Q4 2026 around IAE. He also gave the first public confirmation of the October hands-on sessions: a small number of original backers and long-time content creators will play Squadron 42 on October 9 and 10, CIG will make "further announcements about our release plans during this time," and "a specific release date" will follow "shortly afterwards."',
